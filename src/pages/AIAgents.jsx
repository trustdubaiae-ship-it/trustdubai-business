...
const AGENTS = [
  { key: 'orchestrator', name: 'Nexus', icon: 'ti-sitemap', color: '#eab308', tag: 'Give a goal — it puts the right agents to work', orchestrator: true, photo: true,
  ...
  { key: 'marketing', name: 'Pulse', icon: 'ti-speakerphone', color: '#ec4899', tag: 'Ads, social, offers & campaigns',
  ...
  { key: 'estimator', name: 'Quanta', icon: 'ti-calculator', color: '#0099cc', tag: 'Rough costs, scope & BOQ', photo: true,
  ...
  { key: 'sales', name: 'Apex', icon: 'ti-target-arrow', color: '#22c55e', tag: 'Follow-ups, objections & closing',
  ...
  { key: 'content', name: 'Muse', icon: 'ti-pencil', color: '#8b5cf6', tag: 'Posts, captions & portfolio', photo: true,
  ...
  { key: 'advisor', name: 'Oracle', icon: 'ti-bulb', color: '#f59e0b', tag: 'Pricing, growth & operations',
  ...
  { key: 'accounts', name: 'Abacus', icon: 'ti-report-money', color: '#0ea5e9', tag: 'Revenue, VAT, invoices & cash flow',
  ...
  { key: 'project_manager', name: 'Atlas', icon: 'ti-stack-2', color: '#06b6d4', tag: 'Schedules, milestones & coordination',
  ...
  { key: 'tender', name: 'Forge', icon: 'ti-file-text', color: '#6366f1', tag: 'Proposals, bids & company profile',
  ...
  { key: 'hr', name: 'Cortex', icon: 'ti-users', color: '#14b8a6', tag: 'Hiring, letters & team',
