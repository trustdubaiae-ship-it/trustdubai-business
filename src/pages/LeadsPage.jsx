              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ display: mobile ? 'block' : 'grid', gap: 16, gridTemplateColumns: mobile ? undefined : 'auto 1fr 1fr', alignItems: 'start' }}>
                  <div style={{ display: 'flex', flexDirection: mobile ? 'row' : 'column', flexWrap: 'wrap', gap: 7, marginBottom: mobile ? 12 : 0 }}>
                    ...
                    {(lead.phone || lead.email) && <button onClick={() => addToContacts(lead)} title="Save to phone contacts" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 12px', borderRadius: 9, background: 'rgba(245,158,11,0.16)', color: '#d97706', border: 'none', cursor: 'pointer', fontSize: 11.5, fontWeight: 700 }}><i className="ti ti-user-plus" style={{ fontSize: 15 }} /> Save</button>}
                  </div>
