  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)', padding: 20 }}>
      <div style={{ background: 'white', borderRadius: 20, padding: '48px 40px', textAlign: 'center', maxWidth: 440, boxShadow: '0 8px 40px rgba(0,0,0,0.08)', border: '1px solid var(--card-border)' }}>
        ...
        <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 22, marginBottom: 10 }}>Access Not Authorized</h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <button onClick={() => window.open('https://wa.me/971503856786?text=Hi, I want access to TrustDubai Business Portal', '_blank')} className="btn btn-primary" style={{ justifyContent: 'center' }}>
            📱 Request Business Access
          </button>
          <button onClick={() => window.location.href = 'https://trustdubai.ae'} className="btn btn-secondary" style={{ justifyContent: 'center' }}>
            🌐 Go to TrustDubai
          </button>
        ...
        <div style={{ marginTop: 20, fontSize: 11, color: '#9ca3af' }}>TrustDubai Business Portal · Authorized Access Only</div>
      </div>
    </div>
  )
}
